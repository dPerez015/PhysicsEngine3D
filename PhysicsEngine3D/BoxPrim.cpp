...
const char* BoxPrim::vertShader_xform =
"#version 330\n\
in vec3 in_Position;\n\
uniform mat4 mvpMat;\n\
void main() {\n\
...
const char* BoxPrim::fragShader_flatColor = 
"#version 330\n\
out vec4 out_Color;\n\
uniform vec4 color;\n\
void main() {\n\
...
GLuint BoxPrim::cubeShaders[2] = { 0,0 };
GLuint BoxPrim::cubeProgram = 0;
bool BoxPrim::shadersCreated = false;
